...
export default async function Nav() {
  ...
  return (
    <div className="sticky top-0 inset-x-0 z-50 group">
      <header className="relative h-20 mx-auto  duration-200 bg-navbar-gradient border-ui-fg-base">
        <nav className="content-container txt-xsmall-plus text-ui-fg-base flex items-center justify-between w-full h-full text-small-regular relative">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 bg-white px-10 py-4 rounded-full shadow-lg">
            <LocalizedClientLink
              href="/"
